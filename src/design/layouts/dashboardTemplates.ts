...
const institutional: DashboardTemplate = {
  id: "institutional",
  name: "Default",
  description: "Executive terminal: snapshot, internals, heatmap, AI and portfolio",
  placements: [
    place("market-snapshot", "snapshot", 0, "full", { pinned: true }),
    place("market-internals", "snapshot", 1, "full", { pinned: true }),
    place("market-pulse", "snapshot", 2, "full", { visible: false }),
    place("market-heatmap", "snapshot", 3, "full"),
    place("market-breadth", "snapshot", 4, "full", { visible: false }),
    place("market-movers", "snapshot", 5, "full"),
    place("ai-opportunities", "main", 0, "full", { pinned: true }),
    place("portfolio-summary", "main", 1, "medium"),
    ...
    place("economic-calendar", "main", 7, "full"),
...
const research: DashboardTemplate = {
  ...
  placements: [
    ...
    place("market-internals", "snapshot", 1, "full"),
    place("ai-opportunities", "main", 0, "full", { pinned: true }),
    ...
    place("market-pulse", "snapshot", 2, "full"),
    place("market-heatmap", "snapshot", 3, "full", { visible: false }),
    place("market-breadth", "snapshot", 4, "full", { visible: false }),
    place("market-movers", "snapshot", 5, "full", { visible: false }),
    place("portfolio-summary", "main", 6, "medium", { visible: false }),
    place("portfolio-health", "main", 7, "large", { visible: false }),
    place("ai-alerts", "main", 8, "medium", { visible: false }),
    place("economic-calendar", "main", 9, "full"),
...
const portfolio: DashboardTemplate = {
  ...
  placements: [
    ...
    place("ai-alerts", "main", 4, "medium", { visible: false }),
    place("market-snapshot", "snapshot", 0, "full"),
    place("market-pulse", "snapshot", 1, "full", { visible: false }),
    place("market-breadth", "snapshot", 2, "full", { visible: false }),
    place("market-heatmap", "snapshot", 3, "full", { visible: false }),
    place("market-movers", "snapshot", 4, "full", { visible: false }),
    place("research-summary", "main", 5, "medium", { visible: false }),
    place("results-calendar", "main", 6, "medium"),
    place("economic-calendar", "main", 7, "full"),
    place("market-news", "main", 8, "medium"),
...
const swingTrader: DashboardTemplate = {
  id: "swing-trader",
  name: "Swing Trading",
  description: "Pulse, heatmap and AI setups for 1–4 week trades",
  placements: [
    place("market-snapshot", "snapshot", 0, "full", { pinned: true }),
    place("market-internals", "snapshot", 1, "full"),
    place("market-pulse", "snapshot", 2, "full"),
    ...
    place("ai-alerts", "main", 2, "medium", { visible: false }),
    place("market-news", "main", 3, "medium"),
    place("results-calendar", "main", 4, "medium"),
...
const investor: DashboardTemplate = {
  ...
  placements: [
    ...
    place("economic-calendar", "main", 3, "full"),
...
const minimal: DashboardTemplate = {
  ...
  placements: [
    ...
    place("market-heatmap", "snapshot", 3, "full", { visible: false }),
    place("market-movers", "snapshot", 4, "full", { visible: false }),
    place("portfolio-summary", "main", 2, "medium", { visible: false }),
    ...
    place("results-calendar", "main", 7, "medium", { visible: false }),
...
const executive: DashboardTemplate = {
  ...
  placements: [
    place("market-snapshot", "snapshot", 0, "full"),
    place("portfolio-summary", "main", 0, "medium", { pinned: true }),
    place("watchlist", "main", 1, "medium"),
    place("ai-brief", "main", 2, "small", { visible: false }),
    place("research-summary", "main", 3, "medium", { visible: false }),
    place("portfolio-health", "main", 4, "large"),
    place("validation-center", "main", 5, "small"),
    place("results-calendar", "main", 6, "medium"),
    ...
    place("market-heatmap", "snapshot", 3, "full", { visible: false }),
    place("market-movers", "snapshot", 4, "full", { visible: false }),
    place("ai-opportunities", "main", 8, "full", { visible: false }),
    place("ai-alerts", "main", 9, "medium", { visible: false }),
    place("economic-calendar", "main", 10, "full"),
    place("earnings-intelligence", "bottom", 0, "full", { visible: false }),
  ],
};
