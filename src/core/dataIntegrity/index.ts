...
export {
  ...
  buildKnowledgeGraph,
  queryGraph,
  analyzeDependencies as analyzeKnowledgeDependencies,
  analyzeImpact,
  findRelationships,
  getKnowledgeMetrics,
...
export {
  ...
  authorize,
  validateAccess,
  evaluatePolicy as evaluateSecurityPolicy,
...
/** Prompt 9F.32 Institutional Validation Platform — final Sprint 9F integration. */
export {
