...
import type { MonteCarloExportState } from "@/lib/optimization";
...
export interface SimulationExportToolbarProps {
  disabled: boolean;
  exportState: MonteCarloExportState;
  onExport: (format: ExportFormat) => void;
}

export const SimulationExportToolbar = memo(function SimulationExportToolbar({
  disabled,
  exportState,
  onExport,
}: SimulationExportToolbarProps) {
  return (
    <Card hover={false} padding="sm" data-testid="simulation-export-toolbar">
      <CardHeader title="Simulation Exports" subtitle="PDF · CSV · Excel · JSON" />
