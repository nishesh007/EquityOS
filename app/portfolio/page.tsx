...
export default async function PortfolioPage() {
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Portfolio"
        subtitle={`Holdings, performance and monitored opportunities · ${screenerHealth.portfolioScreens} institutional portfolio screens · workspace ${screenerHealth.workspaceReady ? "ready" : screenerHealth.emptyMessage} · research ${researchWorkspace.ready ? `${researchWorkspace.openTabs} tabs · timeline ${researchWorkspace.integrationReady ? `${researchWorkspace.decisionCount} decisions` : researchWorkspace.integrationEmptyMessage}` : researchWorkspace.emptyMessage}`}
      />
