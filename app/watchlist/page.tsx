...
export default async function WatchlistPage() {
  ...
  return (
    <div className="p-6">
      <PageHeader
        title="Watchlist"
        subtitle={`Track symbols, price action and upcoming earnings · ${screenerHealth.watchlistScreens} institutional watchlist screens · workspace ${screenerHealth.workspaceReady ? "ready" : screenerHealth.emptyMessage} · research ${researchWorkspace.ready ? `${researchWorkspace.openTabs} tabs · automation ${researchWorkspace.automationReady ? `${researchWorkspace.favoriteCount} favorites` : researchWorkspace.automationEmptyMessage}` : researchWorkspace.emptyMessage}`}
      />
